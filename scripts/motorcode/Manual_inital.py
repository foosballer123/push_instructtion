...
if __name__ == '__main__':
    ...
    while not rospy.is_shutdown():
        ...
        if (sensor1 == 1 and sensor3 == 1 and sensor5 ==1 and sensor6 == 1 ):     
            break
